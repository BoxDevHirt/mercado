<nav id="navigation" class="block_navigation">
    <ul id="list_ul">
        ...
        <li><a href="{{ Route('admin.request', 'solicitacoes-solicitacoes') }}"><i
                    class="fa-solid fa-code-pull-request"></i> Solicitações</a></li>
        <li><a href="{{ Route('admin.request.product', 'solicitacoes-produtos') }}"><i
                    class="fa-solid fa-code-pull-request"></i> Produtos Solicitações</a></li>
        <li><a href="{{ Route('client') }}"><i class="fa-solid fa-earth-americas"></i> Web</a></li>
    </ul>
    <div id="close_menu" class="action_menu">
        <i class="d_icon fa-solid fa-arrow-up-right-from-square"></i>
    </div>
</nav>
@push('script')
    <script>
